...
private:
    ...
    void multToPolynomial(vector<FieldType>& p1, vector<FieldType>& p2);

    void scaleToPolynomial(FieldType c, vector<FieldType>& p);

    void dividePolynomial(vector<FieldType>& p1, vector<FieldType>& p2,
...
public:
    ...
    FieldType evalPolynomial(FieldType x, vector<FieldType>& polynomial);
    ...
    bool reconstruct(vector<FieldType>& alpha,  // input
                     ...
                     int degree, vector<FieldType>& polynomial);
    ...
    void interpolate(vector<FieldType>& y, vector<FieldType>& polynomial);
...
template <class FieldType>
void ECC<FieldType>::trimZeroes(vector<FieldType>& a)
{
    int i = a.size();
    FieldType Zero = *(_field->GetZero());
    while (i > 0 && a[i - 1] == Zero) {
        i--;
    }
    a.resize(i);
    return;
...
template <class FieldType>
void ECC<FieldType>::addToPolynomial(
    vector<FieldType>& p1,  // input
...
template <class FieldType>
void ECC<FieldType>::multToPolynomial(vector<FieldType>& p1,
                                      vector<FieldType>& p2)
{
    int p1_size = p1.size();
    int p2_size = p2.size();
...
template <class FieldType>
void ECC<FieldType>::scaleToPolynomial(FieldType c, vector<FieldType>& p)
{
    int p_deg = p.size();
...
template <class FieldType>
void ECC<FieldType>::dividePolynomial(vector<FieldType>& p1,
                                      vector<FieldType>& p2,
                                      vector<FieldType>& q,  // quotient
...
template <class FieldType>
void ECC<FieldType>::extendedEuclideanPartial(vector<FieldType>& p1,  // input
        vector<FieldType>& p2,  // input
        vector<FieldType>& a1,  // output
        vector<FieldType>& a2,  // output
        vector<FieldType>& r,   // output
...
template <class FieldType>
FieldType ECC<FieldType>::evalPolynomial(FieldType x,
        vector<FieldType>& polynomial)
{
...
template <class FieldType>
void ECC<FieldType>::interpolate(vector<FieldType>& x,  // input
                                 vector<FieldType>& y,  // input
                                 vector<FieldType>& polynomial)
{
...
template <class FieldType>
void ECC<FieldType>::applyMask(vector<FieldType>& fullVec)
{
    int nActive = 0;
...
template <class FieldType>
void ECC<FieldType>::interpolate(vector<FieldType>& y,
                                 vector<FieldType>& polynomial)
{
    // use _alpha as x.
...
template <class FieldType>
void ECC<FieldType>::setAlpha(vector<FieldType>& alpha)
{
    trimZeroes(alpha);
    _alpha = alpha;
...
template <class FieldType>
void ECC<FieldType>::setField(TemplateField<FieldType>* field)
{
    _field = field;
    return;
}
...
template <class FieldType>
void ECC<FieldType>::computeG0(vector<FieldType>& alpha,
                               vector<FieldType>& g0)
{
...
template <class FieldType>
void ECC<FieldType>::setPartyInactive(int partyId)
{
...
template <class FieldType>
void ECC<FieldType>::printPolynomial(vector<FieldType>& p)
{
    int deg = 0;
    for (auto e : p) {
        cout << e << "*x^" << (deg++) << " ";
...
template <class FieldType>
bool ECC<FieldType>::reconstruct(
    vector<FieldType>& alpha,  // input x of size n
...
template <class FieldType>
bool ECC<FieldType>::reconstruct(vector<FieldType>& code,  // input
                                 int degree, vector<FieldType>& polynomial)
{
    vector<FieldType> activeAlpha = _alpha;
...
#endif /* BAPARTY_H_ */  // author: Hanjun Li <hanjunl@andrew.cmu.edu>
